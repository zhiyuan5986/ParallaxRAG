...
def parse_args_llama():
    ...
    # Multi-GPU Training
    parser.add_argument("--use_multi_gpu", type=str, default='True', help="Whether to use multiple GPUs")
    parser.add_argument("--gpu_memory_per_device", type=int, default=23, help="Memory limit per GPU in GB")
    ...
    parser.add_argument("--max_memory", type=csv_list, default=[23,23])
